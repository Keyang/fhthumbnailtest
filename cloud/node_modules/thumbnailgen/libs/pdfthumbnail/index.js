...
function _moveFile(oriPath,targetPath,cb){
    fs.rename(oriPath,targetPath,cb);
}

function _initTmpFolder(cb){
    console.log("checkTmpPath"+pdfGenTmp);
...
function _convertPDFToPNG(pdfFile,cb){
    ...
    im.convert([pdfFile,targetFile],function(err,stdout){
        if (err){
            cb(err);
        }else{
            ...
            if (fs.existsSync(targetFile)){
                ...
                console.log("multiple page pdf");
                var guessFileName=pdfGenTmp+"/"+baseName+"-0.png";
                console.log(guessFileName);
